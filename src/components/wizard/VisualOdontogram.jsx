...
// Dati posizionamento arcate con Offset Etichette (lx, ly)
const DENTAL_ARCH_DATA = {
  upper: [
    { id: '18', x: 22, y: 155, rot: -15, lx: -42, ly: 5 },
    { id: '17', x: 30, y: 120, rot: -20, lx: -42, ly: 0 },
    { id: '16', x: 42, y: 88, rot: -25, lx: -40, ly: -5 },
    { id: '15', x: 58, y: 60, rot: -38, lx: -36, ly: -12 },
    { id: '14', x: 78, y: 40, rot: -50, lx: -30, ly: -22 },
    { id: '13', x: 102, y: 24, rot: -65, lx: -20, ly: -30 },
    { id: '12', x: 128, y: 14, rot: -78, lx: -10, ly: -38 },
    { id: '11', x: 152, y: 10, rot: -88, lx: 0, ly: -40 },
    { id: '21', x: 178, y: 10, rot: 88, lx: 0, ly: -40 },
    { id: '22', x: 202, y: 14, rot: 78, lx: 10, ly: -38 },
    { id: '23', x: 228, y: 24, rot: 65, lx: 20, ly: -30 },
    { id: '24', x: 252, y: 40, rot: 50, lx: 30, ly: -22 },
    { id: '25', x: 272, y: 60, rot: 38, lx: 36, ly: -12 },
    { id: '26', x: 288, y: 88, rot: 25, lx: 40, ly: -5 },
    { id: '27', x: 300, y: 120, rot: 20, lx: 42, ly: 0 },
    { id: '28', x: 308, y: 155, rot: 15, lx: 42, ly: 5 },
  ],
  lower: [
    { id: '48', x: 22, y: 25, rot: 15, lx: -42, ly: -5 },
    { id: '47', x: 30, y: 60, rot: 20, lx: -42, ly: 0 },
    { id: '46', x: 42, y: 92, rot: 25, lx: -40, ly: 5 },
    { id: '45', x: 58, y: 120, rot: 38, lx: -36, ly: 12 },
    { id: '44', x: 78, y: 140, rot: 50, lx: -30, ly: 22 },
    { id: '43', x: 102, y: 156, rot: 65, lx: -20, ly: 30 },
    { id: '42', x: 128, y: 166, rot: 78, lx: -10, ly: 38 },
    { id: '41', x: 152, y: 170, rot: 88, lx: 0, ly: 40 },
    { id: '31', x: 178, y: 170, rot: -88, lx: 0, ly: 40 },
    { id: '32', x: 202, y: 166, rot: -78, lx: 10, ly: 38 },
    { id: '33', x: 228, y: 156, rot: -65, lx: 20, ly: 30 },
    { id: '34', x: 252, y: 140, rot: -50, lx: 30, ly: 22 },
    { id: '35', x: 272, y: 120, rot: -38, lx: 36, ly: 12 },
    { id: '36', x: 288, y: 92, rot: -25, lx: 40, ly: 5 },
    { id: '37', x: 300, y: 60, rot: -20, lx: 42, ly: 0 },
    { id: '38', x: 308, y: 25, rot: -15, lx: 42, ly: -5 },
  ]
};
...
const VisualOdontogram = ({ selected = [], onToggle, configured = [] }) => (
  // LAYOUT MODIFICATO: gap ridotto a 4 per avvicinare le arcate orizzontalmente
  <div className="flex flex-col md:flex-row gap-0 md:gap-4 justify-center items-center select-none w-full">
    {/* INVERTIAMO L'ORDINE DELL'ARRAY: 'lower' (SX) poi 'upper' (DX) */}
    {['lower', 'upper'].map(arch => {
      
      // VIEWBOX OTTIMIZZATI: aumentata larghezza (-50 start) per evitare tagli
      const viewBox = arch === 'upper' 
        ? "-50 -60 440 260" 
        : "-50 -10 440 260";

      return (
        <div key={arch} className="text-center w-full flex-1">
          {/* Etichetta Arcata */}
          ...
          <div className="relative">
            <svg 
              width="100%" 
              viewBox={viewBox} 
              className="overflow-visible max-w-[480px] mx-auto" 
